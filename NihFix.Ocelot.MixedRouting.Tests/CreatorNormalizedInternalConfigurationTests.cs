...
{
    public class CreatorNormalizedInternalConfigurationTests
    {
        ...
        public CreatorNormalizedInternalConfigurationTests()
        {
        ...
        [Fact]
        public async Task Ctor_ReroutesMustBeFilteredFromStandardRoutes_And_OtherPropsShouldBeTheSame()
        {
            var normalizedConfig = new CreatorNormalizedInternalConfiguration(_sourceInternalConfiguration);

            Assert.Single(normalizedConfig.ReRoutes, _dynamicReRoute);
            Assert.Same(
